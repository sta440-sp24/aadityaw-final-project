...
x <- sf::as_Spatial(st_geometry(mmr_dist))
...
write_rds(reard_st_prim, "reard_st_sec.rds")

df <- tibble(sc_pop = mmr_dist2$pc11_pca_p_sc, 
                 other_pop = mmr_dist2$pc11_pca_tot_p - sc_pop)
reard_sc_prim <- as.list(seg::spseg(x, df, smoothing = "kernel"))

write_rds(reard_sc_prim, "reard_sc_sec.rds")
...
write_rds(reard_obc, "reard_obc_sec.rds")
...
write_rds(reard_comb, "reard_comb_sec.rds")
