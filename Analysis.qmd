...
library(stringr)
library(dukestm)
shurg_shp <- st_read("data/shrug-shrid-poly-shp/shrid2_open.shp")
shurg_sec <- st_read("data/shrug-pca11-csv/pc11_pca_clean_shrid.csv")
shrug_subdist_shp <- st_read("data/shrug-pc11subdist-poly-shp/subdistrict.shp")

shrug_dist_shp <- st_read("data/shrug-pc11dist-poly-shp/district.shp")
```
