...
An example of the permutation test for which p-values were computed can be found below. This is for the SC vs. all comparison of population concentration:
