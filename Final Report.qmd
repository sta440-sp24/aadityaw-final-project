...
rownames(prim) <- c("SC pop vs. all", "ST pop vs. all", "SC/ST firm ownership vs. all", 
                    "OBC firm ownership vs. all")

prim |>
  kable(digits = 3, col.names = c("Aspatial D Index", "Morrill's D Index", 
...
rownames(sec) <- c("SC pop vs. all", "ST pop vs. all", "SC/ST firm ownership vs. all", 
                    "OBC firm ownership vs. all")
sec |>
  kable(digits = 3, col.names = c("Aspatial D Index", "Morrill's D Index"),
...
It would would also have been conducted with newer data
