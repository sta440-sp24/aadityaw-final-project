...
On repeated efforts, RS measures failed to compute for any of our desired secondary comparisons. This may owe to the number of subdistricts simply being too small to obtain an accurate kernel estimation of the population density function. However, examining the remaining indices, very similar results are seen to the primary outcome, and no conclusions are majorly affected, showing that this analysis is fairly robust to the MAUP. The smaller values overall for subdistrict indices indicate that at a more granular level, population compositions are actually more heterogeneous, which may signal the necessity of an even smaller unit of analysis than shrids for the most accurate results.

## 4. Conclusion and Discussion

This project's analysis showed less segregation for SC individuals than initially may have been expected, but still displayed convincing evidence for the segregation of STs. In a city where deforestation has accelerated significantly due to infrastructure development and new construction [@Pathak_2019; @Singh_2022], this is a particular meaningful finding, as Mumbai's affected swamp/forested areas are historically home to Kolis, many subgroups of whom are STs. As Figure 1 displayed, a higher concentration of SC/ST are found outside the city; while a good portion of this is in forested areas, a high concentration can also be seen in the exurban centres of Badlapur/Ambarnath (far east of the city), indicating possible displacement.
...
In the future, this study could be conducted at the census' *ward* level; wards correspond directly to specific neighborhoods in the region that have sociological and historical value (rather than the more arbitrary geography of shrids), yielding more meaningful conclusions. A further improvement on data source could entail using National Family Health Survey (NFHS) data, whose latest available release is much newer (2019-21). However, neither Ward-level nor NFHS data are currently available in SHRUG, so cleaning them appropriately (i.e. implementing SHRUG's rigorous standardization process, as well as obtaining their geographic granularity) would be a months/years long affair more suitable for a thesis project. With these newer, more granular datasets, it may be interesting to examine specific religions and ethnic breakdowns for a fuller picture, or better still, look at specific sub-castes and their segregation, especially with the recent groundbreaking caste surveys conducted by states like Bihar. Finally, if the 2-shrid problem was solved, re-computing RS measures would give us a better picture of the landscape of discrimination against SCs.
